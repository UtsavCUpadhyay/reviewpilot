...
export default function RefundPolicyPage() {
  return (
    <ContentPage eyebrow="Legal" title="Refund & Cancellation Policy" intro="Fair, simple rules for cancellations and refunds.">
      ...
      <p>You can cancel or reschedule a consultation for free up to 4 hours before the appointment for a full refund. Cancellations after that, or no-shows, may not be eligible for a refund.</p>
      ...
      <p>Reserved live-class spots can be cancelled up to 2 hours before the class. Free monthly classes are not refundable but can be rescheduled subject to availability.</p>
